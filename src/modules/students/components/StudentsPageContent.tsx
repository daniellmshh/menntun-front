...
import type { SchoolOption, Student, StudentDetailTab, StudentGroup } from "../types";
...
export default function StudentsPage() {
  ...
  const [detailTab, setDetailTab] = useState<StudentDetailTab>("general");
  ...
  return (
    <ModuleGuard moduleKey="students" requireSchoolContext={true}>
      ...
      {mounted && isDetailModalOpen && detailStudent && (
        <StudentDetailModal
